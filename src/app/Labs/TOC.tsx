...
export default function TOC() {
 ...
 return (
   <Nav variant="pills">
     ...
     <NavItem>
       <NavLink href="/Labs/Lab2" id="wd-lab2-link" as={Link}as={Link} className={`nav-link ${pathname.endsWith("Lab2") ? "active" : ""}`}>
         Lab 2 </NavLink>
     </NavItem>
     <NavItem>
     ...
     <NavItem>
       <NavLink href="https://github.com/Dimcirui/kambaz-next-js/tree/a2" id="wd-github">Github</NavLink>
     </NavItem>
   </Nav>
);}
