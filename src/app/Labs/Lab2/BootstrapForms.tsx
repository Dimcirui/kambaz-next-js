import { FormLabel, FormControl, FormSelect, FormCheck, Form, InputGroup, Row, Col, Button } from "react-bootstrap";
            ...
            <Form>
                ...
                <fieldset>
                    <Row className="mb-3">
                        ...
                        <FormCheck type="checkbox" label="Remember me" name="rememberMe" className="mt-3"/>
                        </Col>
                    </Row>
                </fieldset>
