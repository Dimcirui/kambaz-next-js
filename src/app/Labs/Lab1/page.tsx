"use client"
// onClick (at line 182) is a client-side feature and cannot be used in a server Component, so I added "use client" to make it function properly
...
This is the third paragraph. Wrap each paragraph with the paragraph tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        My favorite recipe:
        <ol id="wd-braisedpork">
          <li>Cut pork belly into small cubes.</li>
          <li>Stir fry pork belly until browned.</li>
          <li>Add shallots and garlic, then saute until fragrant.</li>
          <li>Add mushrooms and stir fry for a while</li>
          <li>Pour in soy sauce and sugar.</li>
          <li>Add water to cover the pork, then add marinade.</li>
          <li>Bring to a boil, then reduce heat and simmer for 1 hour.</li>
          <li>Open the lid of the pot and cook over high heat until the sauce thickens.</li>
          <li>Serve the braised pork over a bowl of hot rice, enjoy!</li>
        </ol>
