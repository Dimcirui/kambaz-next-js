      ...
      <div id="wd-dashboard-courses">
        ...
        <div className="wd-dashboard-course">
          <Link href="/Courses/1235" className="wd-dashboard-course-link">
            <Image src="/images/apcspcore.jpg" width={200} height={150} />
            <div>
              <h5> CS1235 APCSP </h5>
              <p className="wd-dashboard-course-title">
        ...
        <div className="wd-dashboard-course">
          <Link href="/Courses/1236" className="wd-dashboard-course-link">
            <Image src="/images/csintro.jpg" width={200} height={150} />
            <div>
        ...
        <div className="wd-dashboard-course">
          <Link href="/Courses/1237" className="wd-dashboard-course-link">
            <Image src="/images/cybersecurity.jpg" width={200} height={150} />
            <div>
        ...
        <div className="wd-dashboard-course">
          <Link href="/Courses/1238" className="wd-dashboard-course-link">
            <Image src="/images/fullstack.jpg" width={200} height={150} />
            <div>
        ...
        <div className="wd-dashboard-course">
          <Link href="/Courses/1240" className="wd-dashboard-course-link">
            <Image src="/images/newmedia.jpg" width={200} height={150} />
            <div>
        ...
        <div className="wd-dashboard-course">
          <Link href="/Courses/1241" className="wd-dashboard-course-link">
            <Image src="/images/datascience.jpg" width={200} height={150} />
            <div>
